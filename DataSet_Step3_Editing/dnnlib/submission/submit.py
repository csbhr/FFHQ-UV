...
def _populate_run_dir(submit_config: SubmitConfig, run_dir: str) -> None:
    ...
    files += util.list_dir_recursively_with_ignore(run_func_module_dir_path,
    ...
    files += util.list_dir_recursively_with_ignore(dnnlib_module_dir_path,
                                                   ignores=submit_config.run_dir_ignore,
    ...
    files += [(os.path.join(dnnlib_module_dir_path, "submission", "internal",
                            "run.py"), os.path.join(run_dir, "run.py"))]
