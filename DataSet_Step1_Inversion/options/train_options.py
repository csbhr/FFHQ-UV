...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--test_workers',
                                 default=2,
                                 type=int,
        ...
        self.parser.add_argument('--start_from_latent_avg',
                                 action='store_true',
        ...
        self.parser.add_argument('--stylegan_size',
                                 default=1024,
                                 type=int,
        ...
        self.parser.add_argument('--board_interval',
                                 default=50,
                                 type=int,
        ...
        self.parser.add_argument('--use_w_pool',
                                 action='store_true',
        ...
        self.parser.add_argument('--save_training_data',
                                 action='store_true',
